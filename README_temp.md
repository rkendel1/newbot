...
- **Exchange B**: Coinbase Perpetual Futures (CEX)
...
- SHORT $10,000 BTC on Coinbase    (pay    -$5.00)
...
**Recommended:**
- Enable IP restrictions on both Bybit and Coinbase API keys
...
Exchanges: Bybit (CEX) ↔ Coinbase Perpetual Futures (CEX)
...
============================================================
Strategy: Delta-Neutral Funding Rate Arbitrage
Exchanges: Apex Omni (DEX) ↔ Coinbase Perpetual Futures (CEX)
Asset: BTC Perpetual Futures
============================================================
